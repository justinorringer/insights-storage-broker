...
message_json_unpack_error = Counter("storage_broker_message_json_upack_error_count", "Total message with bad json", ["topic"])
storage_copy_error = Counter("storage_broker_object_copy_error_count", "Total errors encountered by the copy operation", ["bucket"])
storage_copy_success = Counter("storage_broker_object_copy_success_count", "Total successful object moves", ["bucket"])
invalid_validation_status = Counter("storage_broker_invalid_status_count", "Total invalid status messages received", ["service"])
